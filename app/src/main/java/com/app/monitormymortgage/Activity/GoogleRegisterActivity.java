...
import com.app.monitormymortgage.Fragments.GoogleRegisterFragment;
        ...
        Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(
                new ResultCallback<Status>() {
                    ...
                    public void onResult(@NonNull Status status) {
                        ...
                        PreferenceManager.getDefaultSharedPreferences(getBaseContext()).edit().remove("GoogleFirstName").apply();
                        PreferenceManager.getDefaultSharedPreferences(getBaseContext()).edit().remove("GoogleLastName").apply();
                        PreferenceManager.getDefaultSharedPreferences(getBaseContext()).edit().remove("GoogleEmail").apply();

...
import com.app.monitormymortgage.Common.CustomTextWatcher;
...
import com.app.monitormymortgage.DataHolderClasses.MortgageDetailsEdit;
...
import com.app.monitormymortgage.Fragments.PrimaryResidenceFragment;
...
public class EditMortgageActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        new ViewDialog(this).showPopupAddMortgage(EditMortgageActivity.this, R.string.mortgage_incomplete_title);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        globalMethods = new GlobalMethods(this.getApplicationContext());
        ...
        if (CommonConstants.mDebug) Log.v(TAG, "Term 2 " + termInYear);
        ...
        ViewDialog.showProgress(R.string.help_screen_one, EditMortgageActivity.this, getResources().getString(R.string.please_wait));
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new ViewDialog(EditMortgageActivity.this).showPopupAddMortgage(EditMortgageActivity.this, R.string.mortgage_incomplete_title);
            }
        });
        myCalendar = Calendar.getInstance();
        typeface = Typeface.createFromAsset(getAssets(), "fontawesome-webfont.ttf");
        toastMessage = new ToastMessage(this);
        alertDialogBuilder = new AlertDialog.Builder(EditMortgageActivity.this);
        ...
        btn_save_monitor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!GlobalMethods.haveNetworkConnection(EditMortgageActivity.this) && !MeteorSingleton.getInstance().isConnected()) {
                    toastMessage.showToastMsg(R.string.no_network_found, Toast.LENGTH_SHORT);
                } else {
                    if (valiadationStepThree()) {
                        flagError = true;
                        ViewDialog.showProgress(R.string.help_screen_one, EditMortgageActivity.this, getResources().getString(R.string.progress_save_mortgage));
        ...
        actualInterestRateEditText.addTextChangedListener(new CustomTextWatcher(actualInterestRateEditText));
        discountRateEditText.addTextChangedListener(new CustomTextWatcher(discountRateEditText));
                ...
                try {
                    ...
                    if (imageUri != null && (data == null || data.getData() == null)) {
                        ...
                        if (fileSizeMb <= 5) {
                            ...
                            ViewDialog.showAlertPopUp(EditMortgageActivity.this, getResources().getString(R.string.file_upload_limit), getResources().getString(R.string.error));
                        }
                        ...
                        try {
                            ...
                            if (getMimeType(fileName).contains("png") || getMimeType(fileName).contains("jpg") || getMimeType(fileName).contains("jpeg")) {
                                ...
                                ViewDialog.showAlertPopUp(EditMortgageActivity.this, getResources().getString(R.string.supported_file_formats), getResources().getString(R.string.error));
                            }
                        } catch (Exception e) {
                            if (CommonConstants.mDebug)
                    ...
                    public void onSuccess(String result) {
                        ...
                        try {
                            ...
                            if (jsonObjectResult.getString("status").equalsIgnoreCase("true")) {
                                ...
                                mortgageDetailsEdit.setAmortizationTerm(jsonObjectResultMain.getString("amortization_period"));
                                ...
                                periodTextView.setText(jsonObjectResultMain.getString("amortization_period_unit"));

                                if (jsonObjectResultMain.has("prime_rate_adjustment_percentage")) {
                                    mortgageDetailsEdit.setPrime_rate_adjustment_percentage(jsonObjectResultMain.getString("prime_rate_adjustment_percentage"));
                                }
                                ...
                                if (jsonObjectResultMain.has("prime_rate_plus_minus"))
                                    mortgageDetailsEdit.setOperator(jsonObjectResultMain.getString("prime_rate_plus_minus"));
...
//                        ViewDialog.hideProgress();
    ...
    public void setMortgageDetails() {
        ...
        if (!mortgageDetailsEdit.getMortgageOriginalValue().contains(".")) {
            ...
            double total = Double.parseDouble(mortgageDetailsEdit.getMortgageOriginalValue());
            roundUP(total);
            totalMortgageEditText.setText(String.valueOf(f.format(total)));
        }
        ...
        if (!mortgageDetailsEdit.getAmortizedMortgageValue().contains(".")) {
            ...
            double total = Double.parseDouble(mortgageDetailsEdit.getAmortizedMortgageValue());
            roundUP(total);
            currentAmortizedMortgageValueEditText.setText(String.valueOf(f.format(total)));
        }
...
//        periodTextView.setText("");
        ...
        if (!mortgageDetailsEdit.getPaymentAmt().contains(".")) {
            ...
            double total = Double.parseDouble(mortgageDetailsEdit.getPaymentAmt());
            roundUP(total);
            currentPaymentAmtEditText.setText(String.valueOf(f.format(total)));
        }
        ...
        if (mortgageDetailsEdit.getRateDisc().toString().equalsIgnoreCase("0")) {
            discountRateEditText.setText("0.00");
        ...
        actualStartDateEditText.setText(GlobalMethods.convertMilliSecondsToDate(mortgageDetailsEdit.getStartDate()));
        actualMaturityDateEditText.setText(GlobalMethods.convertMilliSecondsToDate(mortgageDetailsEdit.getMaturityDate()));

        if (!mortgageDetailsEdit.getCreditLineAmt().contains(".")) {
            creditLineAmtEditText.setText(mortgageDetailsEdit.getCreditLineAmt() + ".00");
        } else {
            double total = Double.parseDouble(mortgageDetailsEdit.getCreditLineAmt());
            roundUP(total);
            creditLineAmtEditText.setText(String.valueOf(f.format(total)));
        }
        if (!mortgageDetailsEdit.getSavintAmtMonth().contains(".")) {
            ...
            double total = Double.parseDouble(mortgageDetailsEdit.getSavintAmtMonth());
            roundUP(total);
            savingAmtPerMonthEditText.setText(String.valueOf(f.format(total)));
        }
        ...
        if (!mortgageDetailsEdit.getSavingAmtRemTerm().contains(".")) {
            ...
            double total = Double.parseDouble(mortgageDetailsEdit.getSavingAmtRemTerm());
            roundUP(total);
            actualremainingTermEditText.setText(String.valueOf(f.format(total)));
        }
        notifyMe = mortgageDetailsEdit.getNotifyMe();

        rateIncrease = mortgageDetailsEdit.getRateIncrease();
        if (mortgageDetailsEdit.getRateIncrease().equalsIgnoreCase("10")) {
            actualRateIncreaseTextView.setText("0.10%");
        } else if (mortgageDetailsEdit.getRateIncrease().equalsIgnoreCase("15")) {
            actualRateIncreaseTextView.setText("0.15%");
        } else if (mortgageDetailsEdit.getRateIncrease().equalsIgnoreCase("20")) {
            actualRateIncreaseTextView.setText("0.20%");
        } else if (mortgageDetailsEdit.getRateIncrease().equalsIgnoreCase("25")) {
        ...
        if (mortgageDetailsEdit.getType().equalsIgnoreCase("Variable")) {

            changeUIForVariableRate();
            actualInterestRateEditText.setText(mortgageDetailsEdit.getPrime_rate_adjustment_percentage());
            ...
            operatorTextView.setText(mortgageDetailsEdit.getOperator());
            double calculatedValue;
            double interestRate = Double.parseDouble(actualInterestRateEditText.getText().toString());
            if (operatorTextView.getText().toString().equalsIgnoreCase("+")) {
                calculatedValue = primeRate + interestRate;
                Log.v("TAG calculated Value", "" + mortgageDetailsEdit.getInterestRate());
                variableInterestRateTextView.setText(String.valueOf(f.format(calculatedValue)));
            } else if (operatorTextView.getText().toString().equalsIgnoreCase("-")) {
                calculatedValue = primeRate + (-interestRate);
                variableInterestRateTextView.setText(String.valueOf(f.format(calculatedValue)));
            }
        } else if (mortgageDetailsEdit.getType().equalsIgnoreCase("Fixed")) {
    ...
    public void changeUIForVariableRate() {
        interesrRateTextView.setText("Prime Rate Adjustment");  //refer string.xml
        ...
        if (informationTextView.isShown()) {
            informationTextView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!actualInterestRateEditText.getText().toString().equalsIgnoreCase("")) {
                        interestOne = Double.parseDouble(actualInterestRateEditText.getText().toString());
                    }
                    double calculatedValue;
                    if (operatorTextView.getText().toString().equalsIgnoreCase("+")) {
                    ...
                    if (operatorTextView.getText().toString().equalsIgnoreCase("") || actualInterestRateEditText.getText().toString().equalsIgnoreCase("")) {
                        ViewDialog.showPopUpPrimeRate(EditMortgageActivity.this, "-", String.valueOf(f.format(primeRate)) + " %", "-", "+/-");
                    } else {
                        double rate = Double.parseDouble(actualInterestRateEditText.getText().toString());
                        ViewDialog.showPopUpPrimeRate(EditMortgageActivity.this, String.valueOf(f.format(calculatedValue)) + "%", String.valueOf(f.format(primeRate)) + " %", String.valueOf(f.format(rate)) + " %", operatorTextView.getText().toString());
                    }
                }
            });
        }
...
//        }
        ...
        ErisCollectionManager.getInstance().callMethod("updateMortgage", new Object[]{hashMap}, new ResultListener() {
            ...
            public void onSuccess(String result) {
                ...
                // Update the mortgageID
                try {
                    JSONObject jsonObjectMain = new JSONObject(result);
                    JSONObject jsonObjectData = jsonObjectMain.getJSONObject("data");
                    JSONObject jsonObjectResult = jsonObjectData.getJSONObject("result");
                    mortgageID = jsonObjectResult.getString("mortgage_id");
                    ...
                    if (jsonObjectMain.getString("status").equalsIgnoreCase("false")) {
                        ...
                        if (fileDataList.size() <= 0) {
                            ...
                            ViewDialog.hideProgress();
                            ViewDialog.showProgress(R.string.help_screen_one, EditMortgageActivity.this, getResources().getString(R.string.progress_analyze_mortgage));
                            //finish();
                            analyzeNowAPI();
                        }

                        // Attachments, but they have already been updated
                        ...
                        // Attachments that need to be updated
                        else {
                            for (int i = 0; i < fileDataList.size(); i++) {
                                ViewDialog.hideProgress();
                                ViewDialog.showProgress(R.string.help_screen_one, EditMortgageActivity.this, "Uploading " + i + " of " + fileDataList.size());
                                 /* Added for network failure handling. */
                                if (i == 0) {
                                    attachDocuments(jsonObjectResult.getString("mortgage_id"), i, "Y");
                                } else {
                                    attachDocuments(jsonObjectResult.getString("mortgage_id"), i, "N");
                                }
                            }
            ...
            public void onError(String error, String reason, String details) {
                ...
                ErisCollectionManager.getInstance().reconnectMeteor(new ErisConnectionListener() {
                    ...
                    public void onDisconnect() {
                        ViewDialog.hideProgress();
                        showAlertPopUp(EditMortgageActivity.this, "App cannot perform current operation. Please retry when connected.", "No Network connection");
                    }
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("true")) {
                        ...
                        if (jsonObjectData.getString("code").equalsIgnoreCase("16108")) {
                            //alertDialog.dismiss();
                            ViewDialog.hideProgress();
                            showAlertPopUp(EditMortgageActivity.this, "Mortgage looks good at this time. We will keep you posted.", "Monitor My Mortgage");
                            ...
                            LayoutInflater inflater = ((Activity) EditMortgageActivity.this).getLayoutInflater();
                            ...
                            viewLaterButton.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    finish();
                                    globalMethods.replaceFragment(new MyDashboardFragment(), null, null);
                                }
                            });
                                        ...
                                        if (GlobalMethods.haveNetworkConnection(EditMortgageActivity.this) && MeteorSingleton.getInstance().isConnected()) {
                                            ...
                                            if (jsonObjectData.getString("code").equalsIgnoreCase("16110")) {
                                                ...
                                                if (jsonObjectResult.getString("opportunity_type").equalsIgnoreCase("Variable Rate")) {
                                                    ...
                                                    Intent intent = new Intent(EditMortgageActivity.this, OpprThreeVariableRateNotificationActivity.class);
                                                    ...
                                                    String opportunityId = jsonObjectResult.getString("opportunity_id");
                                                    Intent intent = new Intent(EditMortgageActivity.this, OpportunityOneSavingsActivity.class);
                                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                    intent.putExtra("opportunity_id", opportunityId);
                                                    intent.putExtra("activity_title", title);
                                                    startActivity(intent);
                                                    ...
                                                    String opportunityId = jsonObjectResult.getString("opportunity_id");
                                                    Intent intent = new Intent(EditMortgageActivity.this, OpprTwoApporchingMaturityActivity.class);
                                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                    intent.putExtra("opportunity_id", opportunityId);
                                                    intent.putExtra("activity_title", title);
                                                    startActivity(intent);
                                                    ...
                                                    String opportunityId = jsonObjectResult.getString("opportunity_id");
                                                    Intent intent = new Intent(EditMortgageActivity.this, OpprFourPrimeRateChangeActivity.class);
                                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                    intent.putExtra("opportunity_id", opportunityId);
                                                    intent.putExtra("activity_title", title);
                                                    startActivity(intent);
                                            ...
                                            alertDialog.dismiss();
                                            ViewDialog.showNetworkPopup(EditMortgageActivity.this, getResources().getString(R.string.app_cant_perform_operation), getResources().getString(R.string.no_network_connection));
                                            finish();
                                        }
    ...
    public void attachDocuments(final String mortgageID, int counter, String isAttachmentUpdatedFlag) {
        ...
        stringObjectHashMap.put("is_attachment_updated", isAttachmentUpdatedFlag);
        stringObjectHashMap.put("lang", "en");
...
//                analyzeNowAPI();
            ...
            public void onError(String error, String reason, String details) {
                ...
                ErisCollectionManager.getInstance().reconnectMeteor(new ErisConnectionListener() {
                    ...
                    public void onDisconnect() {
                        ViewDialog.hideProgress();
//                        if (!GlobalMethods.haveNetworkConnection(EditMortgageActivity.this) && !ErisCollectionManager.getInstance().isConnectedMeteor()) {
                        showAlertPopUp(EditMortgageActivity.this, "App cannot perform current operation. Please retry when connected.", "No Network connection");
//                        }
                    }

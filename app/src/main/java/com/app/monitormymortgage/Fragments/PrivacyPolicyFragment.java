...
public class PrivacyPolicyFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        (getActivity()).setTitle(R.string.privacy_policy_fragment);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(PrivacyPolicyFragment.this.getActivity()).create();
        ViewDialog.showProgress(R.string.help_screen_one, PrivacyPolicyFragment.this.getActivity(), getResources().getString(R.string.please_wait));
...
//                Toast.makeText(PrivacyPolicyFragment.this.getActivity(), "Oh no! " + description, Toast.LENGTH_SHORT).show();
...
//                alertDialog.show();
        ...
        webView.loadUrl(CommonConstants.privacyPolicyURL);
        return rootview;
    }
